...
import { addQueryParamToURL, uuidInQueryParam, getFavorites, updateFavoritesInLocalStorage, goToOrigin } from "../utils";
...
export const Activity = () => {
  ...
  const renderCreateButton = () => {
    ...
    return (
      <button
        ...
        className="bg-green-500 text-white px-4 py-2 ml-auto rounded disabled:bg-gray-300"
      >
        Create
      </button>
    );
  ...
  const renderSavingIndicator = () => {
    ...
    return <span className="text-sm ml-auto text-green-500">Saving...</span>;
  };
